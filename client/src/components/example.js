...
export default function NavBar() {
  ...
  return (
    <div class="bg-primary-500 font-medium text-md px-4 py-2">
      <div class="mg:flex flex-col lg:flex flex-direction:row justify-between">
        <div className="flex flex-direction:row justify-between lg:">
          <div>
            <Link to="/">
        ...
        <div class={`sm: justify-between mg:hidden ${isOpen && hidden} `}>
          <div
